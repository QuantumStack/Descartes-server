exports.up = knex => knex.schema.raw('CREATE EXTENSION IF NOT EXISTS "uuid-ossp"').createTable('courses', (table) => {
...
exports.down = knex => knex.schema.dropTableIfExists('courses').raw('DROP EXTENSION IF EXISTS "uuid-ossp"');
